...
# Input paths
parser.add_argument('--model', type=str, default='./OSIC/save/4e-4/xe/model-best.pth',
                    help='path to model to evaluate')
parser.add_argument('--cnn_model', type=str,  default='resnet101',
                    help='resnet101, resnet152')
parser.add_argument('--infos_path', type=str,
                    default='./OSIC/save/4e-4/xe/infos_OSIC_xe-best.pkl',
...
parser.add_argument('--image_root', type=str, default='./Dataset/MS_COCO/MS_COCO_384',
                    help='In case the image paths have to be preprended with a root path to an image folder')
# For evaluation on MSCOCO images from some split:
parser.add_argument('--input_label_h5', type=str, default='./Dataset/MS_COCO/cocotalk_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
parser.add_argument('--input_json', type=str, default='./Dataset/MS_COCO/cocotalk.json',
...
# misc
parser.add_argument('--id', type=str, default='osic_xe',
...
# Set sample options
import eval_utils
loss, split_predictions, lang_stats = eval_utils.eval_split(my_swin, model, crit, loader, vars(opt))
